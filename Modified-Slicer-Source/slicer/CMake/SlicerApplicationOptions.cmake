...
if(NOT DEFINED Slicer_DEFAULT_HOME_MODULE)
  set(Slicer_DEFAULT_HOME_MODULE "OralSurgModuleHome" CACHE STRING "Name of the module that Slicer activates on start-up by default")
...
if(NOT DEFINED Slicer_DEFAULT_FAVORITE_MODULES)
  set(Slicer_DEFAULT_FAVORITE_MODULES "OralSurgModuleHome, DentalSegmentator, DentImplImaging, RegisterModule, FastModelAlign, VirtualProsth, GenericImplCreator, OralSurgData, Data, Markups, SegmentEditor, Dynamic Modeler"
...
if(NOT DEFINED Slicer_DISCLAIMER_AT_STARTUP)
  set(Slicer_DISCLAIMER_AT_STARTUP "Το SlicerFSP προορίζεται κυρίως για ερευνητική χρήση./<br><br>SlicerFSP is intended primarily for research use.<br><br>1. Εγκαταστήστε/Install extensions:<br><br>DentalSegmentator<br><br>SegmentEditorExtraEffects<br><br>SlicerIGT<br><br>SlicerMorph<br><br>SurfaceWrapSolidify<br><br>2. Επανεκκινήστε/Restart SlicerFSP."  
  CACHE STRING "Text displayed at the first startup of Slicer in a popup window")
